...
if(isset($_GET['help'])) //this page is used as the popup help section
{
	...
	echo "<span style='font-size:18px;'>".ONFLYPRJ."-".PROJECT." v".VERSION." ".$lang['help_doc']."</span><br/><br/>";
...
if(!$auth->isAuthorized()) //user is not authorized - display the login screen
{
	...
	echo "<h1><span id='logo'>".ONFLYPRJ." - ".PROJECT."</span> <span id='version'>v".VERSION."</span></h1>";
	...
	echo "<span style='font-size:11px;'>".$lang['powered']." <a href='".PROJECT_URL."' target='_blank' style='font-size:11px;'>".PROJECT."</a> v".VERSION." | "; 
...
else //user is authorized - display the main application
{
	...
	echo '<table class="body_tbl" width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td valign="top" class="left_td" style="width:100px;">';
	echo "<div id='leftNav'>";
	echo "<h1><a href='".PAGE."'>";
	echo "<span id='logo'>".ONFLYPRJ." Admin</span>";
	echo "</a></h1>";
	...
	echo "</div>";
	echo "</div>";
	echo '</td><td valign="top" id="main_column" class="right_td" style="padding:0 2px 9px 9px;">';
			...
			case "table_search":
				...
				else
				{
					...
					for($i=0; $i<sizeof($result); $i++)
					{
					  ...
					  echo "</td>";
					  echo $tdWithClassLeft;
					  if($type=="INTEGER" || $type=="REAL" || $type=="NULL" || $type=='VARCHAR')
			...
			case "row_create":
				...
				for($j=0; $j<$num; $j++)
				{
					...
					for($i=0; $i<sizeof($result); $i++)
					{
						...
						$scalarField = $type=="integer" || $type=="real" || $type=="null" || $type=='varchar';
						$tdWithClass = "<td class='td".($i%2 ? "1" : "2")."'>";
						$tdWithClassLeft = "<td class='td".($i%2 ? "1" : "2")."' style='text-align:left;'>";
						echo "<tr>";
						echo $tdWithClassLeft;
